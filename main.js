...
// Plugin zaregistrujeme hned na začátku, aby fungoval i při úplně
// prvním vykreslení (renderAll běží dřív než initScrollAnimations()).
...
function animateSkillBars() {
  ...
  if (window.gsap && window.ScrollTrigger) {
    bars.forEach((bar) => {
      // pokud má pruh z dřívějška ještě navázanou animaci na starý (smazaný) prvek,
      // toto vytvoří novou vazbu na aktuální prvek v DOMu
      gsap.to(bar, {
