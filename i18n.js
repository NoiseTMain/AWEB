...
const I18N = {
  cs: {
    ...
    "audit.benefit2": "Výsledek do minuty, přímo na obrazovce",
    "audit.benefit3": "30+ kontrolních bodů + AI shrnutí",
    "audit.privacyNote": "Váš e-mail používáme jen pro případné navázání kontaktu. Žádný spam.",
    ...
    "audit.loading": "Analyzuji web přes Google Lighthouse — může to chvíli trvat...",
    "audit.resultsTitle": "Výsledky analýzy",
    "audit.scorePerformance": "Rychlost",
    "audit.scoreSeo": "SEO",
    "audit.scoreBestPractices": "Bezpečnost a postupy",
    "audit.scoreAccessibility": "Přístupnost / UX",
    "audit.topIssuesTitle": "Nejvýznamnější zjištění",
    "audit.errorGeneric": "Analýzu se nepodařilo dokončit — možná web blokuje automatické prohlížeče, nebo je dočasně přetížené veřejné API. Poptávku jsem si i tak uložil a ozvu se ručně.",
    "audit.messageGenerated": "Návrh zprávy pro klienta (vidíš i v administraci)",
  ...
  en: {
    ...
    "audit.benefit2": "Results in under a minute, right on screen",
    "audit.benefit3": "30+ checkpoints + an AI summary",
    "audit.privacyNote": "Your email is only used if we follow up. No spam.",
    ...
    "audit.loading": "Analyzing the website via Google Lighthouse — this can take a moment...",
    "audit.resultsTitle": "Analysis results",
    "audit.scorePerformance": "Speed",
    "audit.scoreSeo": "SEO",
    "audit.scoreBestPractices": "Security & best practices",
    "audit.scoreAccessibility": "Accessibility / UX",
    "audit.topIssuesTitle": "Key findings",
    "audit.errorGeneric": "The analysis couldn't be completed — the site may block automated browsers, or the public API is temporarily overloaded. Your request was saved and I'll follow up manually.",
    "audit.messageGenerated": "Suggested message for this client",
